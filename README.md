...
- **HMS V2.0:** A modern Hospital Management System featuring an AI-ready backend, real-time conflict prevention, and automated task queues using Celery/Redis.  
- **Automated LLM Data Explainer:** A pipeline designed to ingest complex datasets and use Llama-3 to translate mathematical results into human-readable insights.  
- **MediVault:** A secure, unified health records platform utilizing JWT-based RBAC and SHA-256 for high-standard data security. 

##  Professional Recognition
- Google Big Code Challenge 2026: Ranked in the top 15,000 globally.  
- Top Course Grades: Achieved top marks in Python and Java Programming within the IIT Madras BS program.  
...
### 📫 Let's Connect: [LinkedIn](https://linkedin.com/in/roshan-warade-102b17287) | [Email](mailto:roshanwarade2004@gmail.com)
